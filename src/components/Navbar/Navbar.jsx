...
function Navbar() {
  return (
    <div className="grid grid-cols-10 py-4 justify-items-strech border-b mb-3 pl-8 pr-8">
        <div className="col-span-1 font-semibold text-lg leading-5 flex justify-center items-center justify-self-start"><span className="block pr-2 lg:hidden"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-5">
